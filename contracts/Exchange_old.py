...
#     # @return Amount of Tokens bought.
#     """
#     ndao_sold:uint256 = self.factory.buyNdao(value=msg.value)
#     return self.ndaoToTokenInput(ndao_sold, min_tokens, deadline, msg.sender, msg.sender)
#
#
# @public
...
#
# @public
# def ethToTokenSwapOutput(tokens_bought: uint256, max_ndao: uint256, deadline: timestamp) -> uint256:
#     """
#     # @notice Convert eth to Tokens.
#     # @dev User specifies maximum input max_ndao and exact output.
#     # @param tokens_bought Amount of tokens bought.
