/*************************************************
  ...
  Author: 张华     Version:   1.0     Date: 2018.10.20
...
/**
 * @dev 读TXT文件或者其它文件，不限于TXT文件
 * @param fileName  文件名,记住这个文件名是相对于工程目录的。如果直接用于node.js,则是相对于本脚本文件的
...
/**
 * @dev 读json文件
 * @param fileName  文件名,记住这个文件名是相对于工程目录的。如果直接用于node.js,则是相对于脚本文件的
 * @return 如果找不到，返回一个null，如果能找到，返回转换后的json对象
 */
